...
//                        s7=new String(packet7.getData(),0,packet7.getLength());
                        System.out.println("服务器收到客户端:"+map.get("ip")+":"+map.get("port")+"发来消息："+s1.trim());
...
//                        System.out.println("服务器收到客户端:"+map.get("ip")+":"+map.get("port")+"发来消息："+s2.trim());
//                        System.out.println("服务器收到客户端:"+map.get("ip")+":"+map.get("port")+"发来消息："+s3.trim());
//                        System.out.println("服务器收到客户端:"+map.get("ip")+":"+map.get("port")+"发来消息："+s4.trim());
//                        System.out.println("服务器收到客户端:"+map.get("ip")+":"+map.get("port")+"发来消息："+s5.trim());
//                        System.out.println("服务器收到客户端:"+map.get("ip")+":"+map.get("port")+"发来消息："+s6.trim());
//                        System.out.println("服务器收到客户端:"+map.get("ip")+":"+map.get("port")+"发来消息："+s7.trim());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
